...
<div style="display: grid; grid-template-columns: 390px 1fr; gap: 20px; max-width: 1350px; margin: 20px auto; padding: 0 15px; height: calc(100vh - 120px);">
    ...
    <!-- COLUMNA DERECHA: FICHA HISTÓRICA Y GRÁFICO -->
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                <thead>
                    <tr style="background: #1a365d; color: #ffffff; text-align: left;">
                        ...
                        <th style="padding: 10px;">Especialista / Estado</th>
...
// 1. LLAMADA AL ARCHIVO ÚNICO PARA CARGAR LA LISTA
...
// 2. LLAMADA AL MISMO ARCHIVO ÚNICO CON EL ID DEL PACIENTE SELECCIONADO
